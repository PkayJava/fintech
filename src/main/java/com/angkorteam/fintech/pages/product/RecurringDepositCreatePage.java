...
public class RecurringDepositCreatePage extends Page {
    ...
    private WebMarkupContainer settingMandatoryDepositBlock;
    private WebMarkupContainer settingMandatoryDepositContainer;
    private Boolean settingMandatoryDepositValue;
    private CheckBox settingMandatoryDepositField;
    private TextFeedbackPanel settingMandatoryDepositFeedback;

    private WebMarkupContainer settingAdjustAdvancePaymentBlock;
    private WebMarkupContainer settingAdjustAdvancePaymentContainer;
    private Boolean settingAdjustAdvancePaymentValue;
    private CheckBox settingAdjustAdvancePaymentField;
    private TextFeedbackPanel settingAdjustAdvancePaymentFeedback;

    private WebMarkupContainer settingAllowWithdrawalBlock;
    private WebMarkupContainer settingAllowWithdrawalContainer;
    private Boolean settingAllowWithdrawalValue;
    private CheckBox settingAllowWithdrawalField;
    private TextFeedbackPanel settingAllowWithdrawalFeedback;
    ...
    private Double settingBalanceRequiredForInterestCalculationValue;
    private TextField<Double> settingBalanceRequiredForInterestCalculationField;
	...
	this.settingMandatoryDepositBlock = new WebMarkupContainer("settingMandatoryDepositBlock");
	...
	this.settingMandatoryDepositField = new CheckBox("settingMandatoryDepositField",
		new PropertyModel<>(this, "settingMandatoryDepositValue"));
	...
	this.settingMandatoryDepositFeedback = new TextFeedbackPanel("settingMandatoryDepositFeedback",
		this.settingMandatoryDepositField);
	this.settingMandatoryDepositContainer.add(this.settingMandatoryDepositFeedback);

	this.settingAdjustAdvancePaymentBlock = new WebMarkupContainer("settingAdjustAdvancePaymentBlock");
	...
	this.settingAdjustAdvancePaymentField = new CheckBox("settingAdjustAdvancePaymentField",
		new PropertyModel<>(this, "settingAdjustAdvancePaymentValue"));
	...
	this.settingAdjustAdvancePaymentFeedback = new TextFeedbackPanel("settingAdjustAdvancePaymentFeedback",
		this.settingAdjustAdvancePaymentField);
	this.settingAdjustAdvancePaymentContainer.add(this.settingAdjustAdvancePaymentFeedback);

	this.settingAllowWithdrawalBlock = new WebMarkupContainer("settingAllowWithdrawalBlock");
	...
	this.settingAllowWithdrawalField = new CheckBox("settingAllowWithdrawalField",
		new PropertyModel<>(this, "settingAllowWithdrawalValue"));
	...
	this.settingAllowWithdrawalFeedback = new TextFeedbackPanel("settingAllowWithdrawalFeedback",
		this.settingAllowWithdrawalField);
	...
	this.settingBalanceRequiredForInterestCalculationBlock = new WebMarkupContainer(
		"settingBalanceRequiredForInterestCalculationBlock");
	...
	this.settingBalanceRequiredForInterestCalculationContainer = new WebMarkupContainer(
		"settingBalanceRequiredForInterestCalculationContainer");
	this.settingBalanceRequiredForInterestCalculationBlock
		.add(this.settingBalanceRequiredForInterestCalculationContainer);
	...
	this.settingBalanceRequiredForInterestCalculationContainer
		.add(this.settingBalanceRequiredForInterestCalculationField);
	...
	this.settingBalanceRequiredForInterestCalculationContainer
		.add(this.settingBalanceRequiredForInterestCalculationFeedback);
	...
	builder.withMandatoryDeposit(
		this.settingMandatoryDepositValue == null ? false : this.settingMandatoryDepositValue);

	builder.withAdjustAdvanceTowardsFuturePayments(
		this.settingAdjustAdvancePaymentValue == null ? false : this.settingAdjustAdvancePaymentValue);

	builder.withAllowWithdrawal(
		this.settingAllowWithdrawalValue == null ? false : this.settingAllowWithdrawalValue);
