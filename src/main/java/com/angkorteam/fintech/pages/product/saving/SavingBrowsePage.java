...
public class SavingBrowsePage extends DeprecatedPage {
    ...
    protected void initDataTable() {
        ...
        this.dataProvider.applyWhere("deposit_type_enum", "deposit_type_enum = " + DepositType.Saving.getLiteral());
    ...
    protected ItemPanel dataColumn(String column, IModel<String> display, Map<String, Object> model) {
        if ("name".equals(column)) {
            ...
            return new LinkCell(SavingPreviewPage.class, parameters, value);
