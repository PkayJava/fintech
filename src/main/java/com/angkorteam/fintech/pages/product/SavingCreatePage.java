...
import com.angkorteam.fintech.provider.saving.*;
...
public class SavingCreatePage extends Page {
    ...
    protected void initDefault() {
        ...
        this.settingOverdraftAllowedContainer.setVisible(this.settingOverdraftAllowedValue != null && this.settingOverdraftAllowedValue);

        this.settingWithholdTaxApplicableContainer.setVisible(this.settingWithholdTaxApplicableValue != null && this.settingWithholdTaxApplicableValue);

        this.settingEnableDormancyTrackingContainer.setVisible(this.settingEnableDormancyTrackingValue != null && this.settingEnableDormancyTrackingValue);
