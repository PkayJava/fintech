...
//        this.provider.boardField("id", "id", Long.class);
        ...
        this.permissionProvider = new OptionMultipleChoiceProvider("m_permission", "code", "code", "concat(code,' ', '[', grouping,']',  ' ', '[', IF(entity_name is NULL , 'N/A', entity_name), ']',' ', '[' , IF(action_name is NULL , 'N/A', action_name),']')");
    ...
    private void actionClick(String s, Map<String, Object> stringObjectMap, AjaxRequestTarget ajaxRequestTarget) {
        ...
        List<String> trueCodes = jdbcTemplate.queryForList("select m_permission.code from m_permission where can_maker_checker = ?", String.class, 1);
