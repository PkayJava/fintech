...
import com.angkorteam.fintech.dto.builder.client.client.ClientRejectTransferBuilder;
...
public class ClientRejectTransferPage extends Page {
    ...
    public IModel<List<PageBreadcrumb>> buildPageBreadcrumb() {
        ...
        {
            PageBreadcrumb breadcrumb = new PageBreadcrumb();
            breadcrumb.setLabel("Reject Transfer");
            BREADCRUMB.add(breadcrumb);
        }
    ...
    protected void saveButtonSubmit(Button button) {
        ...
        ClientRejectTransferBuilder builder = new ClientRejectTransferBuilder();
        builder.withId(this.clientId);
        builder.withNote(this.noteValue);

        JsonNode node = ClientHelper.rejectTransferClient((Session) getSession(), builder.build());
