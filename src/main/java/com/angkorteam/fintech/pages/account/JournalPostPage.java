...
import com.angkorteam.fintech.popup.CreditPopup;
import com.angkorteam.fintech.popup.DebitPopup;
...
public class JournalPostPage extends Page {
    ...
    protected boolean creditAddLinkClick(AjaxLink<Void> link, AjaxRequestTarget target) {
        ...
        this.modalWindow.setContent(new CreditPopup("credit", this.popupModel));
    ...
    protected boolean debitAddLinkClick(AjaxLink<Void> link, AjaxRequestTarget target) {
        this.popupModel.clear();
        this.modalWindow.setContent(new DebitPopup("debit", this.popupModel));
        this.modalWindow.show(target);
        return false;
    }
