...
public interface MProductLoanRecalculationDetails {

    public static final String NAME = "m_product_loan_recalculation_details";
    ...
    public interface Field {
        ...
        public static final String ARREARS_BASED_ON_ORIGINAL_SCHEDULE = "arrears_based_on_original_schedule";

        public static final String PRE_CLOSE_INTEREST_CALCULATION_STRATEGY = "pre_close_interest_calculation_strategy";
