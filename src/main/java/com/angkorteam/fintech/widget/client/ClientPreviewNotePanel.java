...
public class ClientPreviewNotePanel extends Panel {
    ...
    protected void initComponent() {
        ...
        this.noteProvider.applyWhere("note_type_enum", "m_note.note_type_enum = 100");
        this.noteProvider.applyWhere("client_id", "m_note.client_id = " + this.clientId);
    ...
    protected void addButtonSubmit(Button button) {
        ...
        JsonNode node = null;
        try {
            node = ClientHelper.postNoteClient((Session) getSession(), builder.build());
