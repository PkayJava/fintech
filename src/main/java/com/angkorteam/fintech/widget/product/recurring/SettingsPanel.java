...
public class SettingsPanel extends Panel {
    ...
    protected void initComponent() {
        ...
        this.settingMandatoryDepositBlock = new WebMarkupBlock("settingMandatoryDepositBlock", Size.Four_4);
        ...
        this.settingAdjustAdvancePaymentBlock = new WebMarkupBlock("settingAdjustAdvancePaymentBlock", Size.Four_4);
        ...
        this.settingAllowWithdrawalBlock = new WebMarkupBlock("settingAllowWithdrawalBlock", Size.Four_4);
        ...
        this.settingWithholdTaxApplicableBlock = new WebMarkupBlock("settingWithholdTaxApplicableBlock", Size.Four_4);
        ...
        this.settingTaxGroupBlock = new WebMarkupBlock("settingTaxGroupBlock", Size.Four_4);
