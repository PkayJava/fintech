...
public class PaymentTypeHelper {
    ...
    public static JsonNode createPaymentType(JsonNode paymentType) throws UnirestException {
        return Helper.performServerPost(CREATE_PAYMENTTYPE_URL, paymentType);
    }

    public static JsonNode updatePaymentType(JsonNode paymentType) throws UnirestException {
    ...
    public static JsonNode deletePaymentType(String id) throws UnirestException {
