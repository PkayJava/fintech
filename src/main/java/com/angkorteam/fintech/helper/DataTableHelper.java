...
public class DataTableHelper {
    ...
    public static JsonNode createDatatable(JsonNode dataTable) throws UnirestException {
        return Helper.performServerPost(DATATABLE_URL, dataTable);
    }

    public static JsonNode deleteDatatable(final String datatableName) throws UnirestException {
        return Helper.performServerDelete(DATATABLE_URL + "/" + datatableName);
    }

    public static JsonNode deleteDatatableEntries(final String datatableName, final Integer apptableId) throws UnirestException {
