...
public class Helper {
    ...
    public static JsonNode performServerPost(String identifier, String token, String url, JsonNode body) throws UnirestException {
        ...
        return Unirest.post(mifosUrl).header("Authorization", "Basic " + token).header("Fineract-Platform-TenantId", identifier).header("Content-Type", "application/json").body(body).asJson().getBody();
    }
    ...
    public static JsonNode performServerPost(String identifier, String token, String url) throws UnirestException {
        MifosDataSourceManager mifos = SpringBean.getBean(MifosDataSourceManager.class);
        String mifosUrl = mifos.getMifosUrl() + url;
        return Unirest.post(mifosUrl).header("Authorization", "Basic " + token).header("Fineract-Platform-TenantId", identifier).header("Content-Type", "application/json").asJson().getBody();
    }
    ...
    public static JsonNode performServerDelete(String identifier, String token, String url) throws UnirestException {
        MifosDataSourceManager mifos = SpringBean.getBean(MifosDataSourceManager.class);
        String mifosUrl = mifos.getMifosUrl() + url;
        return Unirest.delete(mifosUrl).header("Authorization", "Basic " + token).header("Fineract-Platform-TenantId", identifier).header("Content-Type", "application/json").asJson().getBody();
    }
    ...
    public static JsonNode performServerPut(String identifier, String token, String url, JsonNode body) throws UnirestException {
        MifosDataSourceManager mifos = SpringBean.getBean(MifosDataSourceManager.class);
        String mifosUrl = mifos.getMifosUrl() + url;
        return Unirest.put(mifosUrl).header("Authorization", "Basic " + token).header("Fineract-Platform-TenantId", identifier).header("Content-Type", "application/json").body(body).asJson().getBody();
    }
