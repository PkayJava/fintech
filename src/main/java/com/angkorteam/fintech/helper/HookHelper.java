...
public class HookHelper {
    ...
    public static JsonNode createHook(JsonNode hook) throws UnirestException {
        return Helper.performServerPost(CREATE_HOOK_URL, hook);
    }

    public static JsonNode updateHook(JsonNode hook) throws UnirestException {
    ...
    public static JsonNode deleteHook(String id) throws UnirestException {
