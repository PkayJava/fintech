...
public class FinancialActivityHelper {
    ...
    public static JsonNode create(JsonNode financialActivity) throws UnirestException {
        return Helper.performServerPost("/fineract-provider/api/v1/financialactivityaccounts", financialActivity);
    }

    public static JsonNode update(JsonNode financialActivity) throws UnirestException {
