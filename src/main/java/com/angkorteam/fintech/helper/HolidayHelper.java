...
public class HolidayHelper {
    ...
    public static JsonNode createHoliday(JsonNode holiday) throws UnirestException {
        return Helper.performServerPost(CREATE_HOLIDAY_URL, holiday);
    }

    public static JsonNode activateHoliday(final String id) throws UnirestException {
