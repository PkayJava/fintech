...
//    private final ResponseSpecification responseSpec;
    ...
    private static final String CREATE_GROUP_URL = "/fineract-provider/api/v1/groups";
...
//    }
//
    public static JsonNode updateGroup(JsonNode group) throws UnirestException {
        String groupId = (String) group.getObject().remove("id");
        final String GROUP_ASSOCIATE_URL = "/fineract-provider/api/v1/groups/" + groupId;
        return Helper.performServerPut(GROUP_ASSOCIATE_URL, group);
    }


    public static JsonNode deleteGroup(final String groupId) throws UnirestException {
        final String GROUP_ASSOCIATE_URL = "/fineract-provider/api/v1/groups/" + groupId;
        return Helper.performServerDelete(GROUP_ASSOCIATE_URL);
    }
//
//
