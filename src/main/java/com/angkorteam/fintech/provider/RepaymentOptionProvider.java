...
public class RepaymentOptionProvider extends SingleChoiceProvider<Option> {
    ...
    public List<Option> query(String term, int page) {
        ...
        options.add(new Option("1", "Same Day"));
        options.add(new Option("2", "Move To Next Working Day"));
        options.add(new Option("3", "Move To Next Repayment Meeting Day"));
        options.add(new Option("4", "Move To Previous Working Day"));
        return options;
    }
