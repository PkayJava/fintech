 ...
 */
public class NominalInterestRateTypeProvider extends SingleChoiceProvider<Option> {
    ...
    public List<Option> query(String term, int page) {
        ...
        for (NominalInterestRateScheduleType a : NominalInterestRateScheduleType.values()) {
