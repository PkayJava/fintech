...
public class ClientClassificationProvider extends SingleChoiceProvider {
    ...
    public ClientClassificationProvider() {
        ...
        applyWhere("code_name", MCode.NAME + "." + MCode.Field.CODE_NAME + " = '" + Dropdown.ClientClassification + "'");
