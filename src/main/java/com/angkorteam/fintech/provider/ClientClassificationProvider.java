...
public class ClientClassificationProvider extends OptionSingleChoiceProvider {

    public ClientClassificationProvider() {
        super("m_code_value", "m_code_value.id", "m_code_value.code_value");
        addJoin("inner join m_code ON m_code_value.code_id = m_code.id");
        applyWhere("code_name", "m_code.code_name = '" + Dropdown.ClientClassification + "'");
    }

    public ClientClassificationProvider(String table, String idField, String queryField, String labelField) {
