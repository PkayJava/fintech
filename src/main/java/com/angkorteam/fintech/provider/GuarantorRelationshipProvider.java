...
//
//public class GuarantorRelationshipProvider extends SingleChoiceProvider {
//
//    public GuarantorRelationshipProvider() {
...
//        applyWhere("code_name", MCode.NAME + "." + MCode.Field.CODE_NAME + " = '" + Dropdown.GuarantorRelationship + "'");
