...
public class ConstitutionProvider extends SingleChoiceProvider {

    public ConstitutionProvider() {
        ...
        applyWhere("code_name", MCode.NAME + "." + MCode.Field.CODE_NAME + " = '" + Dropdown.Constitution + "'");
