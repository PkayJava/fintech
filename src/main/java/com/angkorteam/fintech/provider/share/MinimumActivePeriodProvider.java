package com.angkorteam.fintech.provider.share;
...
public class MinimumActivePeriodProvider extends SingleChoiceProvider<Option> {
    ...
    public List<Option> query(String term, int page) {
        ...
        for (MinimumActivePeriod a : MinimumActivePeriod.values()) {
