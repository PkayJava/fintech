...
public class PenaltyChargePopup extends PopupPanel {
    ...
    public PenaltyChargePopup(String name, Map<String, Object> model, ProductPopup productPopup, String currencyCode) {
        super(name, model);
    ...
    protected void initData() {
        ...
        this.chargeProvider.applyWhere("is_penalty", MCharge.Field.IS_PENALTY + " = 1");
        ...
        this.accountProvider.applyWhere("classification_enum", AccGLAccount.Field.CLASSIFICATION_ENUM + " = " + AccountType.Income.getLiteral());
    }
