...
public class PrincipalLoanCyclePopup extends Panel {
    ...
    public PrincipalLoanCyclePopup(String id, ModalWindow window, Map<String, Object> model) {
        super(id);
        this.model = model;
        this.window = window;
    }
    ...
    protected void onInitialize() {
        ...
        this.whenField = new Select2SingleChoice<>("whenField", new PropertyModel<>(this.model, "itemWhenValue"), this.whenProvider);
