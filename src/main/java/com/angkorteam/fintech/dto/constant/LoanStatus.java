...
public enum LoanStatus {
    ...
    Invalid("0", "Invalid"),
    SubmittedAndAwaitingApproval("100", "Submitted And Awaiting Approval"),
    Approved("200", "Approved"),
    Active("300", "Active"),
    WithdrawnByClient("400", "Withdrawn By Client"),
    Rejected("500", "Rejected"),
    Closed("600", "Closed"),
    WrittenOff("601", "Written Off"),
    Rescheduled("602", "Rescheduled"),
    ...
    LoanStatus(String literal, String description, int enumType) {
