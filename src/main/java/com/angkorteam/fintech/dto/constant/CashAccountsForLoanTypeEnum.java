...
public enum CashAccountsForLoanTypeEnum {
    ...
    FundSource("1", "Fund Source"), LoanPortfolio("2", "Loan Portfolio"), InterestOnLoans("3", "Interest On Loans"), IncomeFromFees("4", "Income From Fees"), IncomeFromPenalties("5", "Income From Penalties"), LossesWrittenOff("6", "Losses Written Off"), TransfersSuspense("10", "Transfers Suspense"), OverPayment("11", "Over Payment"), IncomeFromRecovery("12", "Income From Recovery");
