...
public class RecurringBuilder implements Serializable {
    ...
    public RecurringBuilder withChartSlab(LockInPeriod periodType, Date fromPeriod, Date toPeriod,
	    Double amountRangeFrom, Double amountRangeTo, Double annualInterestRate, String description,
	    List<JSONObject> incentives) {
    ...
    public RecurringBuilder withLockinPeriodFrequencyType(LockInPeriod lockInPeriodFrequencyType) {
    ...
    public RecurringBuilder withMinDepositTermTypeId(LockInPeriod minDepositTermTypeId) {
    ...
    public RecurringBuilder withInMultiplesOfDepositTermTypeId(LockInPeriod inMultiplesOfDepositTermTypeId) {
    ...
    public RecurringBuilder withMaxDepositTermTypeId(LockInPeriod maxDepositTermTypeId) {
	...
	if (this.hasInMultiplesOfDepositTermTypeId) {
		...
		object.getObject().put("inMultiplesOfDepositTermTypeId",
			this.inMultiplesOfDepositTermTypeId.getLiteral());
	    } else {
	...
	if (this.hasPreClosurePenalInterestOnTypeId) {
		...
		object.getObject().put("preClosurePenalInterestOnTypeId",
			this.preClosurePenalInterestOnTypeId.getLiteral());
	    } else {
	...
	if (this.hasInterestCalculationDaysInYearType) {
		...
		object.getObject().put("interestCalculationDaysInYearType",
			this.interestCalculationDaysInYearType.getLiteral());
	    } else {
	...
	if (this.hasInterestCompoundingPeriodType) {
		...
		object.getObject().put("interestCompoundingPeriodType",
			this.interestCompoundingPeriodType.getLiteral());
	    } else {
