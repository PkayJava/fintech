...
public interface Dropdown {
    ...
    String Customer_Identifier = "Customer Identifier";
    String LoanCollateral = "LoanCollateral";
    String LoanPurpose = "LoanPurpose";
    String Gender = "Gender";
    String YesNo = "YesNo";
    String GuarantorRelationship = "GuarantorRelationship";
    String AssetAccountTags = "AssetAccountTags";
    String LiabilityAccountTags = "LiabilityAccountTags";
    ...
    String ClientClassification = "ClientClassification";
