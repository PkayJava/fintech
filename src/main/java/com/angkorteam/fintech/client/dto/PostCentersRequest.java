...
public class PostCentersRequest {
    ...
    private List<PostGroupsRequest.Datatable> datatables = new ArrayList<>();
    ...
    public List<PostGroupsRequest.Datatable> getDatatables() {
        return datatables;
    }

    public void setDatatables(List<PostGroupsRequest.Datatable> datatables) {
    ...
    public static class Datatable {
        ...
        private PostGroupsRequest.Data data;
        ...
        public PostGroupsRequest.Data getData() {
            return data;
        }

        public void setData(PostGroupsRequest.Data data) {
            this.data = data;
        }
