...
public class MClientNonPerson extends AbstractTable {
    ...
    private MClientNonPerson(DataContext dataContext) {
        ...
        this.CONSTITUTION_CV_ID = this.delegate.getColumnByName("constitution_cv_id");
        this.IN_CORP_NO = this.delegate.getColumnByName("incorp_no");
        this.IN_CORP_VALIDITY_TILL = this.delegate.getColumnByName("incorp_validity_till");
        this.MAIN_BUSINESS_LINE_CV_ID = this.delegate.getColumnByName("main_business_line_cv_id");
        this.REMARK = this.delegate.getColumnByName("remarks");
    }
