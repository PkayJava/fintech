 ...
 */
@Deprecated
public abstract class DeprecatedPage extends DashboardPage {

    private FeedbackPanel feedbackPanel;

    public DeprecatedPage() {
    }

    public DeprecatedPage(IModel<?> model) {
        super(model);
    }

    public DeprecatedPage(PageParameters parameters) {
        super(parameters);
    }
