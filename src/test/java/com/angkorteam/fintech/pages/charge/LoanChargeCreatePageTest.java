...
public class LoanChargeCreatePageTest {
	...
	String nameValue = this.wicket.getGenerator().generate(20);
	...
	form.setValue("chargeCalculationBlock:chargeCalculationContainer:chargeCalculationField",
		ChargeCalculation.ApprovedAmount.name());
