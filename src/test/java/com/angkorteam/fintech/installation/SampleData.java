    ...
    static {
        try {
...

            {
                ...
                day.put("name", "International New Year Day (2007)");
                day.put("from", DATE_FORMAT.parse("2017-01-01"));
                day.put("to", DATE_FORMAT.parse("2017-01-01"));
                day.put("rescheduled", DATE_FORMAT.parse("2017-01-2"));
                HOLIDAYS.add(day);
            }
            {
                Map<String, Object> day = Maps.newHashMap();
                day.put("name", "Victory over Genocide Day (2007)");
                day.put("from", DATE_FORMAT.parse("2017-01-07"));
                day.put("to", DATE_FORMAT.parse("2017-01-07"));
                day.put("rescheduled", DATE_FORMAT.parse("2017-01-08"));
                HOLIDAYS.add(day);
            }
            {
                Map<String, Object> day = Maps.newHashMap();
                day.put("name", "Meak Bochea Day (2007)");
                day.put("from", DATE_FORMAT.parse("2017-02-11"));
                day.put("to", DATE_FORMAT.parse("2017-02-11"));
                day.put("rescheduled", DATE_FORMAT.parse("2017-02-12"));
                HOLIDAYS.add(day);
            }
            {
                Map<String, Object> day = Maps.newHashMap();
                day.put("name", "International Women's Day (2007)");
                day.put("from", DATE_FORMAT.parse("2017-03-08"));
                day.put("to", DATE_FORMAT.parse("2017-03-08"));
                day.put("rescheduled", DATE_FORMAT.parse("2017-03-08"));
                HOLIDAYS.add(day);
            }
            {
                Map<String, Object> day = Maps.newHashMap();
                day.put("name", "Khmer New Year Day (2007)");
                day.put("from", DATE_FORMAT.parse("2017-04-14"));
                day.put("to", DATE_FORMAT.parse("2017-04-16"));
                day.put("rescheduled", DATE_FORMAT.parse("2017-04-17"));
                HOLIDAYS.add(day);
            }
            {
                Map<String, Object> day = Maps.newHashMap();
                day.put("name", "International Labor Day (2007)");
                day.put("from", DATE_FORMAT.parse("2017-05-01"));
                day.put("to", DATE_FORMAT.parse("2017-05-01"));
                day.put("rescheduled", DATE_FORMAT.parse("2017-05-02"));
                HOLIDAYS.add(day);
            }
            {
                Map<String, Object> day = Maps.newHashMap();
                day.put("name", "Visak Bochea Day (2007)");
                day.put("from", DATE_FORMAT.parse("2017-05-10"));
                day.put("to", DATE_FORMAT.parse("2017-05-10"));
                day.put("rescheduled", DATE_FORMAT.parse("2017-05-11"));
                HOLIDAYS.add(day);
            }
            {
                Map<String, Object> day = Maps.newHashMap();
                day.put("name", "King's Birthday, Norodom Sihamoni (2007)");
                day.put("from", DATE_FORMAT.parse("2017-05-13"));
                day.put("to", DATE_FORMAT.parse("2017-05-15"));
                day.put("rescheduled", DATE_FORMAT.parse("2017-05-16"));
                HOLIDAYS.add(day);
            }
            {
                Map<String, Object> day = Maps.newHashMap();
                day.put("name", "International Children Day (2007)");
                day.put("from", DATE_FORMAT.parse("2017-07-01"));
                day.put("to", DATE_FORMAT.parse("2017-07-01"));
                day.put("rescheduled", DATE_FORMAT.parse("2017-07-02"));
                HOLIDAYS.add(day);
            }
            {
                Map<String, Object> day = Maps.newHashMap();
                day.put("name", "King's Mother Birthday, Norodom Monineath Sihanouk (2007)");
                day.put("from", DATE_FORMAT.parse("2017-07-18"));
                day.put("to", DATE_FORMAT.parse("2017-07-18"));
                day.put("rescheduled", DATE_FORMAT.parse("2017-07-19"));
                HOLIDAYS.add(day);
            }
            {
                Map<String, Object> day = Maps.newHashMap();
                day.put("name", "Pchum Ben Day (2007)");
                day.put("from", DATE_FORMAT.parse("2017-09-19"));
                day.put("to", DATE_FORMAT.parse("2017-09-21"));
                day.put("rescheduled", DATE_FORMAT.parse("2017-09-22"));
                HOLIDAYS.add(day);
            }
            {
                Map<String, Object> day = Maps.newHashMap();
                day.put("name", "Constitutional Day (2007)");
                day.put("from", DATE_FORMAT.parse("2017-09-24"));
                day.put("to", DATE_FORMAT.parse("2017-09-24"));
                day.put("rescheduled", DATE_FORMAT.parse("2017-09-25"));
                HOLIDAYS.add(day);
            }
            {
                Map<String, Object> day = Maps.newHashMap();
                day.put("name", "Commemoration Day of King's Father, Norodom Sihanouk (2007)");
                day.put("from", DATE_FORMAT.parse("2017-10-15"));
                day.put("to", DATE_FORMAT.parse("2017-10-15"));
                day.put("rescheduled", DATE_FORMAT.parse("2017-10-16"));
                HOLIDAYS.add(day);
            }
            {
                Map<String, Object> day = Maps.newHashMap();
                day.put("name", "Anniversary of the Paris Peace Accord (2007)");
                day.put("from", DATE_FORMAT.parse("2017-10-23"));
                day.put("to", DATE_FORMAT.parse("2017-10-23"));
                day.put("rescheduled", DATE_FORMAT.parse("2017-10-24"));
                HOLIDAYS.add(day);
            }
            {
                Map<String, Object> day = Maps.newHashMap();
                day.put("name", "King's Coronation Day, Norodom Sihamoni (2007)");
                day.put("from", DATE_FORMAT.parse("2017-10-29"));
                day.put("to", DATE_FORMAT.parse("2017-10-29"));
                day.put("rescheduled", DATE_FORMAT.parse("2017-10-30"));
                HOLIDAYS.add(day);
            }
            {
                Map<String, Object> day = Maps.newHashMap();
                day.put("name", "Water Festival Ceremony (2007)");
                day.put("from", DATE_FORMAT.parse("2017-11-02"));
                day.put("to", DATE_FORMAT.parse("2017-11-04"));
                day.put("rescheduled", DATE_FORMAT.parse("2017-11-05"));
                HOLIDAYS.add(day);
            }
            {
                Map<String, Object> day = Maps.newHashMap();
                day.put("name", "Independence Day (2007)");
                day.put("from", DATE_FORMAT.parse("2017-11-09"));
                day.put("to", DATE_FORMAT.parse("2017-11-09"));
                day.put("rescheduled", DATE_FORMAT.parse("2017-11-10"));
                HOLIDAYS.add(day);
            }
            {
                Map<String, Object> day = Maps.newHashMap();
                day.put("name", "International Human Rights Day (2007)");
                day.put("from", DATE_FORMAT.parse("2017-12-10"));
                day.put("to", DATE_FORMAT.parse("2017-12-10"));
                day.put("rescheduled", DATE_FORMAT.parse("2017-12-11"));
                HOLIDAYS.add(day);
            }
