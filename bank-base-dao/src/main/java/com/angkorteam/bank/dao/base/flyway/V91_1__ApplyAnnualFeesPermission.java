...
public class V91_1__ApplyAnnualFeesPermission extends LiquibaseJavaMigration {

    @Override
    public Integer getChecksum() {
        return Checksum.V91_1__ApplyAnnualFeesPermission;
    }
    ...
    protected void doMigrate(Context context, DataSource dataSource, NamedParameterJdbcTemplate named, JdbcDataContext dataContext) throws Exception {
        ...
        insert_m_permission(named, m_permission, "transaction_savings", "APPLYANNUALFEE_SAVINGSACCOUNT", "SAVINGSACCOUNT", "APPLYANNUALFEE", 1);
        insert_m_permission(named, m_permission, "transaction_savings", "APPLYANNUALFEE_SAVINGSACCOUNT_CHECKER", "SAVINGSACCOUNT", "APPLYANNUALFEE", 0);
    }
