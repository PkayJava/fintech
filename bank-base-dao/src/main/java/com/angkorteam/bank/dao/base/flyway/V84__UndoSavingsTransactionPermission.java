...
public class V84__UndoSavingsTransactionPermission extends LiquibaseJavaMigration {

    @Override
    public Integer getChecksum() {
        return Checksum.V84__UndoSavingsTransactionPermission;
    }
    ...
    protected void doMigrate(Context context, DataSource dataSource, NamedParameterJdbcTemplate named, JdbcDataContext dataContext) throws Exception {
        ...
        insert_m_permission(named, m_permission, "transaction_savings", "UNDOTRANSACTION_SAVINGSACCOUNT", "SAVINGSACCOUNT", "UNDOTRANSACTION", 1);
        insert_m_permission(named, m_permission, "transaction_savings", "UNDOTRANSACTION_SAVINGSACCOUNT_CHECKER", "SAVINGSACCOUNT", "UNDOTRANSACTION", 0);
    }
