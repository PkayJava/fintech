...
public class V2__MifosXBaseReferenceDataUTF8 extends LiquibaseJavaMigration {
    ...
    public void migrate(Context context) throws Exception {
        ...
        {
            Table ref_loan_transaction_processing_strategy = schema.getTableByName("ref_loan_transaction_processing_strategy");
        ...
        {
            Table m_currency = schema.getTableByName("m_currency");
            dataContext.executeUpdate(callback -> {
        ...
        {
            Table m_organisation_currency = schema.getTableByName("m_organisation_currency");
            dataContext.executeUpdate(callback -> {
                insert_m_organisation_currency(m_organisation_currency, callback, 21, "USD", 2, "US Dollar", "$", "currency.USD");
            });
        }
        {
            Table m_office = schema.getTableByName("m_office");
            dataContext.executeUpdate(callback -> {
        ...
        {
            Table m_group_level = schema.getTableByName("m_group_level");
            dataContext.executeUpdate(callback -> {
        ...
        {
            Table m_code = schema.getTableByName("m_code");
            dataContext.executeUpdate(callback -> {
        ...
        {
            Table m_code_value = schema.getTableByName("m_code_value");
            dataContext.executeUpdate(callback -> {
