...
public class V64__AddPermissionForAssignStaff extends LiquibaseJavaMigration {

    @Override
    public Integer getChecksum() {
        return Checksum.V64__AddPermissionForAssignStaff;
    }
    ...
    public void migrate(Context context) throws Exception {
        ...
        insert_m_permission(named, m_permission, "portfolio", "ASSIGNSTAFF_CLIENT", "CLIENT", "ASSIGNSTAFF", 0);
    }
