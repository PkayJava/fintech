...
public class V17__UpdateStretchyReportingDdl extends LiquibaseJavaMigration {
    ...
    public void migrate(Context context) throws Exception {
        ...
        }
        {
            ...
            Table stretchy_report = schema.getTableByName("stretchy_report");
            Table stretchy_report_tmp = schema.getTableByName("stretchy_report_tmp");
        ...
        }
        {
            // sub change 004
            dataContext.refreshSchemas();
            Table stretchy_parameter = schema.getTableByName("stretchy_parameter");
            Table stretchy_parameter_tmp = schema.getTableByName("stretchy_parameter_tmp");
        ...
        }
        {
            // sub change 006
            dataContext.refreshSchemas();
            Table stretchy_report_parameter = schema.getTableByName("stretchy_report_parameter");
            Table stretchy_report_parameter_tmp = schema.getTableByName("stretchy_report_parameter_tmp");
