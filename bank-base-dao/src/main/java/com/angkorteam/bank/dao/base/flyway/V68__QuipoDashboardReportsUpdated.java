...
public class V68__QuipoDashboardReportsUpdated extends LiquibaseJavaMigration {

    @Override
    public Integer getChecksum() {
        return Checksum.V68__QuipoDashboardReportsUpdated;
    }
    ...
    protected void doMigrate(Context context, DataSource dataSource, NamedParameterJdbcTemplate named, JdbcDataContext dataContext) throws Exception {
        ...
        deleteQuery.addWhere(stretchy_report.getColumnByName("report_name").getName() + " IN (:report_name)",
                "report_name",
                String.class,
                Arrays.asList("FieldAgentStats",
                        "FieldAgentPrograms",
                        "ProgramDetails",
                        "ChildrenStaffList",
                        "CoordinatorStats",
        ...
        deleteQuery.addWhere(m_permission.getColumnByName("entity_name").getName() + " IN (:entity_name)",
                "entity_name",
                String.class,
                Arrays.asList("FieldAgentStats",
                        "FieldAgentPrograms",
