...
public class V32__AssociateDisassociateClientsFromGroupPermissions extends LiquibaseJavaMigration {
    ...
    public void migrate(Context context) throws Exception {
        ...
        NamedParameterJdbcTemplate named = lookJdbcTemplate(context);
        {
            ...
            insert_m_permission(named, m_permission, "portfolio", "ASSOCIATECLIENTS_GROUP", "GROUP", "ASSOCIATECLIENTS", 0);
            insert_m_permission(named, m_permission, "portfolio", "DISASSOCIATECLIENTS_GROUP", "GROUP", "DISASSOCIATECLIENTS", 0);
        }
    }
