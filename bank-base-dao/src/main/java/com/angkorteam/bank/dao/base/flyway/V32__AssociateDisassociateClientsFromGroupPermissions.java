...
public class V32__AssociateDisassociateClientsFromGroupPermissions extends LiquibaseJavaMigration {

    @Override
    public Integer getChecksum() {
        return Checksum.V32__AssociateDisassociateClientsFromGroupPermissions;
    }
    ...
    public void migrate(Context context) throws Exception {
        JdbcDataContext dataContext = lookupDataContext(context);
        {
            ...
            dataContext.executeUpdate(callback -> {
                insert_m_permission(m_permission, callback, "portfolio", "ASSOCIATECLIENTS_GROUP", "GROUP", "ASSOCIATECLIENTS", 0);
                insert_m_permission(m_permission, callback, "portfolio", "DISASSOCIATECLIENTS_GROUP", "GROUP", "DISASSOCIATECLIENTS", 0);
            });
        }
    }
