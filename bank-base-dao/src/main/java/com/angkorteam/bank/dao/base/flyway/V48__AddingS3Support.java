        ...
        try (Database database = lookupDatabase(context)) {
            ...
            }
            {
                ...
                for (int v_counter = 0; v_counter < num_of_clients; v_counter++) {
                    ...
                    Integer temp = named.queryForObject(selectQuery.toSQL(), selectQuery.toParam(), int.class);
                    ...
                    selectQuery.setLimit(0L, 1L);
                    temp = named.queryForObject(selectQuery.toSQL(), selectQuery.toParam(), int.class);
