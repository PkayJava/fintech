...
public class V87__AddPermissionForScheduler extends LiquibaseJavaMigration {

    @Override
    public Integer getChecksum() {
        return Checksum.V87__AddPermissionForScheduler;
    }
    ...
    protected void doMigrate(Context context, DataSource dataSource, NamedParameterJdbcTemplate named, JdbcDataContext dataContext) throws Exception {
        ...
        insert_m_permission(named, m_permission, "jobs", "UPDATE_SCHEDULER", "SCHEDULER", "UPDATE", 0);
    }
